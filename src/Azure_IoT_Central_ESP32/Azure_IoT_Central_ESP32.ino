...
void loop() {
  // LED logic
  int flex_sensor_analog_value = analogRead(FLEX_PIN);

  // Map value 3400-4095 to 0-255 (PWM)
  int mapped_flex_sensor_led_strength = map(flex_sensor_analog_value, 3300, 3900, 255, 0);

  // Send PWM value to led
  analogWrite(LED_PIN, mapped_flex_sensor_led_strength);
